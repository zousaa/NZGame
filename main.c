...
void Print() {
	...
	printf(
			"\n-> Utiliser les fleches pour déplacer le joueur.\n\n->life Index est l'indice de vie et chaque mouvement nécessite 1% d'energie..\n\n Essayer de trouver le trésor.\n\n-> Le jeux continue tant que le joueur n'as pas trouvé le trésor il dispose d'enrgie pour bouger.\n\n Les signaux (Yes,Go ON !) et (NO,Go Back !)permettent de guider le joueur. \n");
